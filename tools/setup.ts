...
const wrapperTemplate = (compiler: string) =>
	`#!/bin/sh\n# Generated by ./tools/setup.ts\nexec $(which ${compiler}) -B${cwd}/build/llvm-bin --target=armv7-linux-gnueabihf --sysroot=${cwd}/build/sysroot -Wl,--sysroot=${cwd}/build/sysroot -fuse-ld=lld --verbose "$@"\n`;
