...
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libcairo.so.2 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/liblcms2.so.2 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libxcb-composite.so.0 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libevdev.so.2 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libpixman-1.so.0 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libmtdev.so.1 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libwacom.so.2 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libgudev-1.0.so.0 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libgobject-2.0.so.0 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libglib-2.0.so.0 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libgio-2.0.so.0 ./build/lib/
docker cp -L oxide-deps:/usr/lib/arm-linux-gnueabihf/libgmodule-2.0.so.0 ./build/lib/
docker cp -L oxide-deps:/lib/arm-linux-gnueabihf/libpcre.so.3 ./build/lib/
docker cp -L oxide-deps:/lib/arm-linux-gnueabihf/libmount.so.1 ./build/lib/
docker cp -L oxide-deps:/lib/arm-linux-gnueabihf/libblkid.so.1 ./build/lib/
docker cp -L oxide-deps:/lib/arm-linux-gnueabihf/libselinux.so.1 ./build/lib/
docker cp -L oxide-deps:/lib/arm-linux-gnueabihf/libpam.so.0 ./build/lib/
docker cp -L oxide-deps:/lib/arm-linux-gnueabihf/libpamc.so.0 ./build/lib/
docker cp -L oxide-deps:/lib/arm-linux-gnueabihf/libpam_misc.so.0 ./build/lib/
docker cp -L oxide-deps:/lib/arm-linux-gnueabihf/libaudit.so.1 ./build/lib/
...
docker cp -L oxide-deps:/usr/share/pam-configs ./build/lib
docker cp -L oxide-deps:/etc/fonts ./build/font-config
docker cp -L oxide-deps:/etc/fonts/conf.d/ ./build/font-config/conf.d
